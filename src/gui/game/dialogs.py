...
class ConfirmExitPreviewDialog:
    """Dialog simple pour quitter le mode preview/play (retour au menu)"""
    ...
    def draw(self, screen, mouse_pos):
        ...
        title = self.font.render("Retourner au menu ?", True, (200, 200, 200))
        title_rect = title.get_rect(center=(self.rect.centerx, self.rect.y + 35))
